  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'total', component: () => import('@/views/manager/Total.vue')},
      ]
    },
    { path: '/login', component: () => import('@/views/Login.vue')},
    { path: '/register', component: () => import('@/views/Register.vue')},
    { path: '/ForgotPassword', component: () => import('@/views/ForgotPassword.vue')},
    { path: '/ForgotUsername', component: () => import('@/views/ForgotUsername.vue')},
    { path: '/byebye', component: () => import('@/views/byebye.vue')},
  ]
})
